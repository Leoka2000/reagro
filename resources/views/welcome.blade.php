            ...
            <div class="mt-16">
                <div class="flex justify-center lg:gap-8">
                    <a href="{{ route('dashboard') }}"
                        class="scale-100 p-6 max-w-2xl bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:stroke-teal-500">
                        <div>
                            <div
